            ...
            <div className="flex items-center justify-center min-h-screen px-4">
              <div className="relative bg-customBeige rounded-lg max-w-3xl p-8">
                ...
                <div className="prose prose-stone max-w-none ">
                  <h3 className='flex justify-center'>À propos de moi ! </h3><br />
                  <p>
                    Passionnée par le développement web, je suis déterminée à concevoir des applications et des solutions numériques innovantes qui améliorent l'expérience utilisateur et répondent aux défis technologiques de demain.                  </p><br />
                  <p>
                  ...
                  <p>
                    Mon expérience à EPITECH m’a permis de maîtriser des technologies comme JavaScript, React, Node.js, Java, etc. J’ai également eu l’opportunité de travailler sur des projets de développement web qui m’ont appris à créer des solutions efficaces, fonctionnelles et orientées utilisateur.                  </p><br />
                  <p>
